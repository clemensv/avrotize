...
class TestAvroToJava(unittest.TestCase):
    ...
    def test_convert_address_avsc_to_java_jackson_annotation(self):
        ...
        convert_avro_to_java(avro_path, java_path, jackson_annotation=True, pascal_properties=True)
    ...
    def test_convert_jfrog_pipelines_jsons_to_avro_to_java_annotated(self):
        ...
        convert_jsons_to_avro(jsons_path, avro_path)
        convert_avro_to_java(avro_path, java_path, pascal_properties=True, avro_annotation=True, jackson_annotation=True)
